...
__version__ = (0, 1, 0)
__author__ = "Alex Mikhalev and Flavio Percoco Premoli, Alberto Paro, " + \
...
try:
    ...
    settings.INSTALLED_APPS.insert(0, 'django_riak_engine')
    # AM:Approach borrowed from mongo engine - we also have riak specific attributes
